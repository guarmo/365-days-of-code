        ...
        <div>
          <div>
            ...
            <div className="my-8">
              ...
              <h1>{currentItem[0].category}</h1>
            </div>

            <div className="my-8">
              <span className="text-xs text-cGray-standard">note</span>
              <h1>{currentItem[0].note}</h1>
            </div>
          </div>
          ...
          <div className="flex justify-center mt-6">
            ...
            <button
              ...
              className="ml-4 w-24 text-xs bg-cYellow-main hover:bg-yellow-600 rounded text-white p-2 py-3 pl-4 pr-4"
            >
              <p className="font-semibold text-xs">Add to list</p>
            </button>
          </div>
        </div>
      )}
