  ...
  return (
    <form className="bg-gray-100 min-h-full p-4 flex flex-col justify-between">
      <div>
        ...
        <div className="my-6">
          <label className="block mb-1 text-sm" for="forms-labelOverInputCode">
            Name
          </label>
          <input
        ...
        <div class="relative inline-block w-full text-gray-700 my-6">
          <select
            class="w-full h-12 pl-3 pr-6 text-sm placeholder-cGray-standard border rounded-lg appearance-none focus:shadow-outline"
      ...
      <div className="flex justify-center mt-6">
        <button class="w-24 bg-gray-100 hover:bg-cGray-standard hover:text-white text-black rounded p-2 py-3 pl-4 pr-4">
          <p class="font-semibold text-xs">Cancel</p>
        </button>

        <button class="ml-4 w-24 bg-cYellow-main hover:bg-yellow-600 rounded text-white p-2 py-3 pl-4 pr-4">
